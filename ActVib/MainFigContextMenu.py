...
class Ui_MainForm(object):
    ...
    def retranslateUi(self, MainForm):
        ...
        self.comboSensor.setItemText(0, QCoreApplication.translate("MainForm", u"IMU1 Accel", None))
        self.comboSensor.setItemText(1, QCoreApplication.translate("MainForm", u"IMU2 Accel", None))
        self.comboSensor.setItemText(2, QCoreApplication.translate("MainForm", u"IMU3 Accel", None))
