...
class Ui_PathModelingDialog(object):
    def setupUi(self, PathModelingDialog):
        ...
        self.groupBox_2 = QGroupBox(PathModelingDialog)
        ...
        sizePolicy3.setHeightForWidth(self.comboSource.sizePolicy().hasHeightForWidth())
        self.comboSource.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.fileName.sizePolicy().hasHeightForWidth())
        self.fileName.setSizePolicy(sizePolicy4)
        ...
        self.bRunModeling = QPushButton(self.groupBox_2)
        self.bRunModeling.setObjectName(u"bRunModeling")

        self.gridLayout_4.addWidget(self.bRunModeling, 3, 0, 1, 1)
        ...
        self.spinBranchesFbk.setValue(5)
        ...
        self.spinSparsityFbk.setValue(10)
        ...
        self.spinSparsitySec.setValue(10)
        ...
        self.spinBranchesSec.setValue(5)
        ...
        self.widget_6 = QWidget(PathModelingDialog)
        self.widget_6.setObjectName(u"widget_6")
        self.horizontalLayout_2 = QHBoxLayout(self.widget_6)
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.bSaveToFile = QPushButton(self.widget_6)
        self.bSaveToFile.setObjectName(u"bSaveToFile")

        self.horizontalLayout_2.addWidget(self.bSaveToFile)

        self.bLoadPathsFromFile = QPushButton(self.widget_6)
        self.bLoadPathsFromFile.setObjectName(u"bLoadPathsFromFile")

        self.horizontalLayout_2.addWidget(self.bLoadPathsFromFile)
        ...
        sizePolicy3.setHeightForWidth(self.bUploadAndRec.sizePolicy().hasHeightForWidth())
        self.bUploadAndRec.setSizePolicy(sizePolicy3)

        self.gridLayout_3.addWidget(self.bUploadAndRec, 0, 0, 1, 1)
    ...
    def retranslateUi(self, PathModelingDialog):
        ...
        self.groupBox_2.setTitle(QCoreApplication.translate("PathModelingDialog", u"Modeling", None))
        ...
        self.bLoadPathsFromFile.setText(QCoreApplication.translate("PathModelingDialog", u"&Load paths from file ...", None))
