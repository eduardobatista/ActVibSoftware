pyuic5 --output=..\ActVib\VibViewWindow.py VibViewWindow.ui
pyuic5 --output=..\ActVib\PlotDialog.py PlotDialog.ui
pyuic5 --output=..\ActVib\UploadDialog.py UploadDialog.ui
